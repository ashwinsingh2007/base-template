...
const sampleTrains = [
  ...
  // ... Add 19 more sample trains here
];

const BookingForm = ({ train, onBook }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <Input type="number" placeholder="Quantity" min="1" max={train.availableSeats} value={quantity} onChange={(e) => setQuantity(parseInt(e.target.value))} required />
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead onClick={() => handleSort("travelTime")}>Travel Time (min)</TableHead>
                      ...
                      <TableCell>
                        <Dialog>
                          ...
                          <DialogContent>
                            ...
                            <BookingForm train={train} onBook={handleBook} />
                          </DialogContent>
                        </Dialog>
                      </TableCell>
                    </TableRow>
